<template>
	...
	<section class="bg-gray-100 py-12">
		<div class="max-w-3xl mx-auto">
			<h1 class="text-3xl font-bold mb-6 text-center">Handelsbetingelser for LejGoPro.dk</h1>
			<div class="bg-white rounded-xl shadow p-8 text-gray-800 space-y-8">
				...
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">3. Produkter og ydelser</h2>
				...
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">4. Bestilling</h2>
					<p>Leje sker via vores hjemmeside. En lejeaftale er bindende, når ordrebekræftelsen er sendt til din e-mail.</p>
				</div>
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">5. Priser og betaling</h2>
				...
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">6. Depositum</h2>
					<p>Der opkræves et depositum ved visse produkter. Depositum returneres, når udstyret er afleveret i god stand.</p>
				</div>
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">7. Afhentning og returnering</h2>
				...
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">11. Reklamation</h2>
				...
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">12. Force Majeure</h2>
					<p>LejGoPro.dk er ikke ansvarlig for manglende opfyldelse af aftalen ved force majeure.</p>
				</div>
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">13. Persondata</h2>
					<p>Vi behandler dine oplysninger i overensstemmelse med vores privatlivspolitik.</p>
				</div>
				<div>
					<h2 class="font-semibold text-xl mb-2 text-[#B8082A]">14. Lovvalg og værneting</h2>
