    ...
    <div class="w-full py-12">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-10 mb-12">
          <NuxtImg src="/eventyr/benjamin-voros-FSvn9jMrDyk-unsplash.jpg" alt="GoPro actionkamera til vandfald og naturfotografering - perfekt til udendørs eventyr" class="rounded-2xl object-cover w-full h-80" width="400" height="320" format="webp" quality="80" loading="lazy" />
          <NuxtImg src="/eventyr/jack-delulio-Sgey0UZt6HY-unsplash.jpg" alt="GoPro til skiløb og vintersport - actionkamera leje til ferie" class="rounded-2xl object-cover w-full h-80" width="400" height="320" format="webp" quality="80" loading="lazy" />
          <NuxtImg src="/eventyr/patrick-hendry-3EtLikBpyfI-unsplash.jpg" alt="GoPro actionkamera til kæledyr og familieaktiviteter - udlejning til alle" class="rounded-2xl object-cover w-full h-80" width="400" height="320" format="webp" quality="80" loading="lazy" />
          <NuxtImg src="/eventyr/spenser-sembrat-I-fihlhsBWk-unsplash.jpg" alt="GoPro til bjergbestigning og ekstrem sport - professionel actionkamera leje" class="rounded-2xl object-cover w-full h-80" width="400" height="320" format="webp" quality="80" loading="lazy" />
          <NuxtImg src="/eventyr/lucas-favre-BRTV55ErUZg-unsplash.jpg" alt="GoPro actionkamera til snowboard og alpinaktiviteter - 4K optagelse kvalitet" class="rounded-2xl object-cover w-full h-80" width="400" height="320" format="webp" quality="80" loading="lazy" />
          <NuxtImg src="/eventyr/cristian-palmer-RaOKzBtN8fI-unsplash.jpg" alt="GoPro til klatring og outdoor aktiviteter - robust actionkamera udlejning" class="rounded-2xl object-cover w-full h-80" width="400" height="320" format="webp" quality="80" loading="lazy" />
        </div>
  ...
  <section class="max-w-7xl mx-auto mt-16 mb-16">
    ...
    <div class="flex flex-wrap justify-center gap-8 my-12 max-w-7xl mx-auto">
      <div class="w-full md:w-[30%] lg:w-[30%] bg-gray-50 rounded-xl p-6 shadow flex flex-col items-center mb-8">
        <NuxtImg src="https://static.gopro.com/assets/blta2b8522e5372af40/blt4a6b3e1087b3473f/663a841c2a72d93452178ba2/01-pdp-h12b-handler-gallery-1920.png?width=1920&quality=80&auto=webp&disable=upscale" alt="GoPro grip håndtag til stabil actionkamera optagelse - professionelt tilbehør" class="w-24 h-24 object-cover rounded-lg mb-3" width="96" height="96" loading="lazy" />
      ...
      <div class="w-full md:w-[30%] lg:w-[30%] bg-gray-50 rounded-xl p-6 shadow flex flex-col items-center mb-8">
        <NuxtImg src="https://static.gopro.com/assets/blta2b8522e5372af40/blt4a3f356761a12e6d/6465f1c79cb8cadbd353f013/pdp-max-enduro-battery-image01-1920-2x.png?width=1920&quality=80&auto=webp&disable=upscale" alt="GoPro ekstra batteri til forlænget optagetid - actionkamera tilbehør leje" class="w-24 h-24 object-cover rounded-lg mb-3" width="96" height="96" loading="lazy" />
      ...
      <div class="w-full md:w-[30%] lg:w-[30%] bg-gray-50 rounded-xl p-6 shadow flex flex-col items-center mb-8">
        <NuxtImg src="https://static.gopro.com/assets/blta2b8522e5372af40/blt5028e412643854ae/65cbdc3afcd8646428eec8a5/01-pdp-h12b-headstrap-gallery-1920.png?width=1920&quality=80&auto=webp&disable=upscale" alt="GoPro headstrap hovedrem til hands-free POV optagelser - perfekt til sport" class="w-24 h-24 object-cover rounded-lg mb-3" width="96" height="96" loading="lazy" />
      ...
      <div class="w-full md:w-[30%] lg:w-[30%] bg-gray-50 rounded-xl p-6 shadow flex flex-col items-center mb-8">
        <NuxtImg src="https://static.gopro.com/assets/blta2b8522e5372af40/bltbc6b778286c13383/64ccd3c131eb6a3cbbd4c86f/01-pdp-h12b-chesty-gallery-1920.png?width=1920&quality=80&auto=webp&disable=upscale" alt="GoPro brystmount til sport og aktiviteter - actionkamera fæstning leje" class="w-24 h-24 object-cover rounded-lg mb-3" width="96" height="96" loading="lazy" />
      ...
      <div class="w-full md:w-[30%] lg:w-[30%] bg-gray-50 rounded-xl p-6 shadow flex flex-col items-center mb-8 relative">
        <!-- Altid inkluderet banner -->
        <div class="absolute -top-2 -right-2 bg-[#B8082A] text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg z-10">
          Altid inkluderet
        </div>
        <NuxtImg src="https://static.gopro.com/assets/blta2b8522e5372af40/blt412da0ad3ddaa0f6/64835bbbcc30bb258ab04e57/pdp-protective-housing-image03-1920-2x.png?width=1920&quality=80&auto=webp&disable=upscale" alt="GoPro beskyttelsescase vandtæt etui - robust beskyttelse mod stød og vand" class="w-24 h-24 object-cover rounded-lg mb-3" width="96" height="96" loading="lazy" />
      ...
      <div class="w-full md:w-[30%] lg:w-[30%] bg-gray-50 rounded-xl p-6 shadow flex flex-col items-center mb-8">
        <NuxtImg src="https://static.gopro.com/assets/blta2b8522e5372af40/blt865a9a20edc4b79b/663a899c8447cbcee89cb5a8/01-pdp-h12b-suction-cup-gallery-1920.png?width=1920&quality=80&auto=webp&disable=upscale" alt="GoPro sugekop til bilruder og glatte overflader - actionkamera mount leje" class="w-24 h-24 object-cover rounded-lg mb-3" width="96" height="96" loading="lazy" />
